...
app.get('/team_stats', function(req, res) {
  ...
  var query_lose = 'SELECT COUNT(*) FROM football_games WHERE home_score < visitor_score';
  db.task('get-everything', task => {
    return task.batch([
      task.any(query_all),
      task.any(query_win),
...
app.get('/player_info/post', function(req, res) {
  ...
  var query_tot_games = "SELECT COUNT(players) FROM football_games WHERE '" + player_id + "' = ANY(players)";
  db.task('get-everything', task => {
    return task.batch([
      task.any(query),
      task.any(query_player),
      task.any(query_tot_games),
    ]);
  })
  .then(data => {
    res.render('pages/player_info', {
